<template>
    <!-- Footer -->
    <footer class="page-footer footer font-small d-flex align-items-center pt-4">
        <img class="footer_graf" src="../assets/footer_graf_left.png" alt="">
        <img class="footer_graf" src="../assets/footer_graf_right.png" alt="">
